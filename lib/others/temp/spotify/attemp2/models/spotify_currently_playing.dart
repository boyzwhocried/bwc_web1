class SpotifyCurrentlyPlayingModel {
  int? timestamp;
  Context? context;
  int? progressMs;
  Item? item;
  ...
  SpotifyCurrentlyPlayingModel.fromJson(Map<String, dynamic> json) {
...
class Actions {
  ...
  Actions.fromJson(Map<String, dynamic> json) {
    disallows = json['disallows'] != null
        ? Disallows.fromJson(json['disallows'])
        : null;
  }
